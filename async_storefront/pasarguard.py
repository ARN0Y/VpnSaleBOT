...
class PasarGuardClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._client = httpx.AsyncClient(
            ...
            trust_env=False,
            headers={"User-Agent": "ElsaVPN-PasarGuard/1.0", "Accept": "application/json"},
        )
    ...
    async def create_user(
        ...
        *,
        ...
        (panel rule, confirmed against v5.0.1). Otherwise ``expire`` is a unix
        timestamp (0 = never); v5 wants an ISO datetime, and if the panel rejects
        that we retry with the raw unix int so it works across point releases.
        """
